...
class ContainerWater {
    public int maxArea(int[] height) {
        ...
        for (int i = 0; i < height.length; i++) {
            ...
            int def = i + 1;
            for (int j = def; j < height.length; j++) {
